...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/resources/css/service-now.css' />">
</head>
<body>
    <div class="container">
        ...
        <div class="complaints-grid">
           <c:if test="${not empty userServiceDetails}" >
            <c:forEach items="${userServiceDetails}" var="user">
            ...
            <c:if test="${empty userServiceDetails}" >
